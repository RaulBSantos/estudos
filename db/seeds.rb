...
freddie_mercury.recently_listeneds.create(album: inside)
freddie_mercury.recently_listeneds.create(album: trinity)
freddie_mercury.recently_listeneds.create(album: gubernator)
freddie_mercury.recently_listeneds.create(album: the_great_bear)
...
diana_ross.recently_listeneds.create(album: the_great_bear)
diana_ross.recently_listeneds.create(album: paw_paw_tree)
diana_ross.recently_listeneds.create(album: aldebaran)
